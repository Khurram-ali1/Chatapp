        ...
        <div className="fixed bottom-6 right-6 flex flex-col items-end">
            {!isOpen && (
                <div className="fixed bottom-6 right-6 flex flex-col items-center space-y-2">
                    ...
                    <motion.button
                        ...
                        className="w-16 h-16 rounded-full bg-white flex items-center justify-center shadow-lg hover:scale-110 transition-all relative"
            ...
            {isOpen && (
                <motion.div
                    ...
                    className="flex flex-col h-[650px] w-[400px] bg-gray-100 rounded-2xl shadow-2xl"
                >
